          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="relative w-72 h-80 md:w-80 md:h-96 border border-primary flex items-end justify-center " style={{width:"27rem"}}>
                ...
                <div className="text-8xl mb-8"><img  src="https://github.com/girisankarplathottathil/girisankar_s_portfolio/blob/main/dist/assets/images/hero.png?raw=true" alt="hero_img" /></div>
              </div>
